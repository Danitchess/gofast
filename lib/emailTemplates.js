...
export function newQuoteRequestEmail(q) {
  return {
    ...
    html: wrap('Nouvelle demande de devis', `
      ...
      <a href="${getSiteUrl()}/admin" style="display:inline-block;background:#e2001a;color:#fff;padding:12px 22px;border-radius:999px;text-decoration:none;font-weight:700;">Ouvrir l'espace employé</a>
    `),
  };
}
